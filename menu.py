...
class Menu:
    ...
    def setup(self):
        ...
        self.main_rect = pygame.Rect(SCREEN_WIDTH / 2 - self.width / 2, menu_top, self.width, total_height)
    ...
    def show_entry(self, text_surf, amount, top, selected):
        ...
        amount_rect = amount_surf.get_rect(midleft=(self.main_rect.right - 20, bg_rect.centery))
